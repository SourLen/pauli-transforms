...
from . import krawtchouk, schur_hahn, schur_factorial
...
def prepare(n, *, backend="hahn", dtype=np.float64):
    ...
    return krawtchouk.prepare(n), schur_tables
...
def pauli_to_orbit(n, coefficients, matrices=None):
    ...
    entries = krawtchouk.inverse(n, coefficients, matrices)
...
def orbit_to_pauli(n, coefficients, matrices=None):
    ...
    return krawtchouk.decompose(n, entries, matrices)
