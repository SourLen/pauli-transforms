...
SERIES = {
    ...
    "anschuetz_public": dict(label="Anschuetz (public)", color_index=1, marker="s", linestyle="--"),
    "anschuetz_optimized": dict(label="Anschuetz (DP)", color_index=2, marker="^", linestyle="-."),
    "anschuetz_tensor_network": dict(label="Anschuetz (tensor network)", color_index=3,
                                     marker="D", linestyle=":"),
